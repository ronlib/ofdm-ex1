...
%         demod_noisy_qpsk_symbols = qamdemod(noisy_qpsk_values, 4);
    ...
    semilogy(siso_snr_ser(:,1), siso_snr_ser(:,2), 'LineWidth', 1);
    grid on;
    hold on;
    xlabel('SNR[db]');
    ylabel('SER');
...
%     figure;
    semilogy(mrc2_snr_ser(:,1), mrc2_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(mrc4_snr_ser(:,1), mrc4_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(stc21_snr_ser(:,1), stc21_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(stc22_snr_ser(:,1), stc22_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(bf22_snr_ser(:,1), bf22_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(bf42_snr_ser(:,1), bf42_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(sm22_snr_ser(:,1), sm22_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
...
%     figure;
    semilogy(sm_zf22_snr_ser(:,1), sm_zf22_snr_ser(:,2), 'LineWidth', 1);
%     grid on;
%     xlabel('SNR[db]');
%     ylabel('SER');
%     title('SER curve for SM ZF 2X2');

    legend('SISO', 'MRC 1X2', 'MRC 1X4', 'STC 2X1', 'STC 2X2', 'BF 2X2', 'BF 4X2', 'SM ML 2X2', 'SM ZF 2X2');
